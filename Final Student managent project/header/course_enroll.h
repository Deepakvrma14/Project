...
void add_course_enroll_f()
{
    ...
    if(selectShift == 1)
        strcpy(add_course_enroll.shift,"online");
    else
        strcpy(add_course_enroll.shift,"offline");
    system("CLS"); title(); add_course_enroll_title();
    ...
    else
    {
        ...
        if(permission == 'Y' || permission == 'y')
        {
            f = fopen("text/course_enroll.txt","r");
            while(!feof(f))
            {
            ...
            if(match == 0)
            {
                f = fopen("text/course_enroll.txt","a");
...
void edit_course_enroll_f()
{
    ...
    printf("\n\t\t\t\t\t\tSelect Shift: ");  scanf("%d",&selectShift);
    if(selectShift == 1)
        strcpy(edit_course_enroll[selectEnroll-1].shift,"online");
    else
        strcpy(edit_course_enroll[selectEnroll-1].shift,"offline");
    system("CLS"); title(); edit_course_enroll_title();
    ...
    else
    {
        ...
        if(permission == 'Y' || permission == 'y')
        {
            f = fopen("text/course_enroll.txt","w");
            for(i=0; i<n; i++)
